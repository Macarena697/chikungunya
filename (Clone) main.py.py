...
# https://rapidapi.com/meteostat/api/meteostat/playground/apiendpoint_8d39939d-4661-41fb-a498-1e76b9930d96?env=undefined
import http.client

conn = http.client.HTTPSConnection("meteostat.p.rapidapi.com")

headers = {
    'x-rapidapi-key': "8a4b224e05msh7db26cbb8f4532bp1b931djsn4a9215830d1a",
...
df_enriquecido = df_limpio.join(
    df_geo_preparado,
    "municipio_id_6_digitos", # La clave de unión
    "left"                  # Usamos "left" para no perder ninguna notificación
)
...
df_final = df_enriquecido.select(
    ...
    "fecha_notificacion",
    "ano_notificacion",
    "nome_municipio", # Ahora viene de nuestra tabla maestra
    "uf",             # Nueva columna (ej: 'SP', 'RJ')
    "nome_estado",    # Nueva columna (ej: 'São Paulo', 'Rio de Janeiro')
    "regiao",         # Nueva columna (ej: 'Sudeste', 'Nordeste')
    "lat_municipio",  # ¡Nueva y crucial! Latitud del municipio
    "lon_municipio",  # ¡Nueva y crucial! Longitud del municipio
    "edad",
    "sexo",
    "gestante",
    "raza_etnia",
...
df_final.write.mode("overwrite").saveAsTable("complete_dataset_test")
